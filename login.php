...
<body>
					...
					<nav>
						<div class="nav-wrapper">
							...
							<ul class="left hide-on-med-and-down">
								...
								<li><a href="registro.php"><i class="material-icons left">group_add</i> Ser Miembro</a></li>
	...
	<main>
		<div class="container">
			<div class="row">
				<form class="col s12 m8 offset-m2 l6 offset-l3" method="post" action="login.php" autocomplete="off">
					<div class="row">
						<br>
						...
						<div class="col s12">
							<p class="center-align">
								<input type="checkbox" class="filled-in" name="remember" id="remember" value="on" checked="checked" />
