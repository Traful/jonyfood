<div ng-controller="addsubcategoria" ng-init="getListas()">
    <div class="container">
        <div class="row">
            <div class="col s3">
                <a href="#subcategorias" class="waves-effect brown darken-2 waves-light btn"><i class="material-icons">reply</i></a>
            </div>
            <div class="col s9">
                <h5 class="sectionTitle">Agregar Item a {{datosCategoria.descripcion}}</h5>
            </div>
        </div>

        <div class="row">
            <div class="col s12 m12">
                <form class="col s12" ng-submit="addSubCtegoria()" autocomplete="off">
                    <br>
